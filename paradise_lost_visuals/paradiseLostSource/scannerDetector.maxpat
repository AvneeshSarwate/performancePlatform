...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 963.0, 292.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1087.0, 337.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "0.08"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 805.377502, 333.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 378.0, 495.0, 82.0, 22.0 ],
					"style" : "",
					"text" : "receive~ sig1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.0, 609.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "send~ sig1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 72.0, 155.0, 209.0, 145.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 444.688751, 559.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "send~ sig2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 444.688751, 428.0, 86.0, 22.0 ],
					"style" : "",
					"text" : "maximum 600"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 444.688751, 519.0, 90.0, 22.0 ],
					"style" : "",
					"text" : "onepole~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.0, 386.0, 86.0, 22.0 ],
					"style" : "",
					"text" : "expr ($f1+0.3)"
				}
